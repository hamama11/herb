    ...
    example_df = pd.DataFrame(
        {
            ...
            "y": [2.3, 3.1, 4.5, 5.9, 7.8, 7.6, 7.1, 6.8, 6.3, 5.9],
        }
    )
...
st.markdown(
    ...
    - 데이터 개수를 늘리거나 CSV로 실험 데이터를 넣어보세요.  
    - 선형, 이차, 로그 모델 중 어떤 것이 **변동을 더 잘 설명**하나요?  
